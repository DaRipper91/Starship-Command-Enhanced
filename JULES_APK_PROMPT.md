...
_Note: This document is the primary source of truth for all Agents. If you identify a better technical path, propose it in the `PROJECT_STATUS.md` before proceeding._
